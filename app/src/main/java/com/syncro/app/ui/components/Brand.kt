...
/**
 * The Syncro mark: two arrows cycling around a 30-unit circle in a 108-unit box,
 * a single flat colour with butt-capped 9-unit strokes (assets/logo.svg).
 */
@Composable
...
/** Mark + "Syncro" lockup used in the home header. */
@Composable
fun Wordmark(modifier: Modifier = Modifier) {
    Row(modifier, verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(10.dp)) {
        SyncroMark(30.dp)
        Text("Syncro", style = MaterialTheme.typography.headlineSmall, color = Syncro.colors.text)
    }
}
